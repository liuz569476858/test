...
def train():
    ...
    with g_cnn.as_default():
        ...
        with sess1.as_default():
            ...
            interact = lstmmodel.interaction(sess1, save_path='model/bi_lstm_attn_model/bi_lstm_attn_model.ckpt')
    ...
    with g_rl.as_default():
        with sess2.as_default():
            ...
            for epoch in range(num_epoch):
                ...
                average_reward = interact.produce_average_reward();
    ...
    interact.save_cnnmodel(save_path='model/union_BilstmATT_rl/union_BilstmATT_rl_model.ckpt')
